...
def generate_hero_image(
    *,
    ...
    prompt = (
        "Create realistic, high-quality image, full-bleed, fills the entire ad canvas, product advertising hero image in 3 different aspect ratios (1:1 square, 9:16 vertical, and 16:9 horizontal). Make sure to fill the entire canvas and not just the product. The product should be the main focus of the image, and the background should stretch to fill the entire canvas. Do not create multiple shots in the same image.\n"
