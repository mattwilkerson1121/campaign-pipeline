...
def generate_hero_image(
    *,
    ...
    prompt = (
        "Create realistic, high-quality image, full-bleed, fills the entire ad canvas, product advertising hero image. Make sure to fill the entire canvas and not just the product. The product should be the main focus of the image, and the background should stretch to fill the entire canvas. Do not create multiple shots in the same image.\n"
